...
/// Bespoke mDNS plugin (Plan 09). Advertises `_starling._tcp` via NWListener
...
public class MdnsPlugin: NSObject, FlutterPlugin {
  private static let methodChannelName = "dev.starling.mdns"
  private static let eventChannelName = "dev.starling.mdns/peers"
  private static let serviceType = "_starling._tcp"

  private let queue = DispatchQueue(label: "dev.starling.mdns")
