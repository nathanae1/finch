...
public class QrScannerPlugin: NSObject, FlutterPlugin {
  private static let methodChannelName = "dev.finch.qr_scanner"
  private static let eventChannelName = "dev.finch.qr_scanner/scans"
  private static let viewType = "dev.finch.qr_scanner_view"

  private let session = AVCaptureSession()
  private let metadataOutput = AVCaptureMetadataOutput()
  private let metadataDelegate = QrMetadataDelegate()
  private var sessionConfigured = false
  private var sessionQueue = DispatchQueue(label: "dev.finch.qr_scanner.session")
