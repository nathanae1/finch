...
/**
 * Bespoke mDNS plugin (Plan 09). Advertises `_finch._tcp` via NsdManager
...
class MdnsPlugin : FlutterPlugin, MethodChannel.MethodCallHandler,
    ...
    companion object {
        private const val METHOD_CHANNEL = "dev.finch.mdns"
        private const val EVENT_CHANNEL = "dev.finch.mdns/peers"
        private const val SERVICE_TYPE = "_finch._tcp."
        private const val MULTICAST_LOCK_TAG = "dev.finch.mdns.lock"
