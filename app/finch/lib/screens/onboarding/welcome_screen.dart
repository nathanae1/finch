            ...
            children: [
              Row(
                children: [
                  ...
                  Text(
                    'Finch',
                    style: finch.typography.h2.copyWith(fontWeight: FontWeight.w500),
                  ),
                ],
              ),
              const Spacer(),
              RichText(
                text: TextSpan(
                  style: finch.typography.displayLarge,
                  children: [
                    const TextSpan(text: 'A social feed\nfor your '),
                    TextSpan(
                      text: 'real',
                      style: finch.typography.displayLarge.copyWith(
              ...
              ConstrainedBox(
                ...
                child: Text(
                  ...
                  style: finch.typography.body.copyWith(color: finch.colors.graphite),
                ),
              ),
