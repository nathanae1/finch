...
/// Bespoke mDNS advertise + resolve for the `_finch._tcp` service. The
...
abstract class MdnsService {
  /// Begins advertising `_finch._tcp` with TXT record `pubkey={pubkey}`
...
class MethodChannelMdnsService implements MdnsService {
  MethodChannelMdnsService({
    ...
    EventChannel? eventChannel,
            ...
            methodChannel ?? const MethodChannel('dev.finch.mdns'),
        _eventChannel =
            eventChannel ?? const EventChannel('dev.finch.mdns/peers');
