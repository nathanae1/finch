...
///
/// The Finch foreground service exists to keep the Android process alive in
...
class ForegroundServiceController {
  ...
  void init() {
    ...
    FlutterForegroundTask.init(
      androidNotificationOptions: AndroidNotificationOptions(
        channelId: 'finch_foreground',
        channelName: 'Finch background mode',
        channelDescription:
            'Keeps Finch reachable to your friends while the app is in '
            'the background.',
  ...
  Future<bool> start() async {
    ...
    final result = await FlutterForegroundTask.startService(
      ...
      notificationTitle: 'Finch is running',
    ...
    if (result is ServiceRequestSuccess) {
      developer.log('foreground service started', name: 'finch.fgservice');
      return true;
    }
    developer.log(
