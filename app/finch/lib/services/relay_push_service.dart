...
/// Relay (Plan 15).
///
/// All writes are authenticated by `X-Finch-Sig: base64(Ed25519.sign(
/// owner_sk, blake2b_256(request_body)))` + `X-Finch-Pubkey:
...
class RelayPushService {
  ...
  Map<String, String> _signHeaders({
    ...
    return {
      'x-finch-pubkey': base64.encode(ownerPubkeyBytes),
