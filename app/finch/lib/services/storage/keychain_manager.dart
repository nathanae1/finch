...
///
///   * `finch_db_key` — 32-byte hex key passed to `PRAGMA key` for SQLCipher.
///   * `finch_secret_key` — base64 Ed25519 secret key for the local identity.
///
...
class KeychainManager {
  ...
  static const String dbKeyName = 'finch_db_key';
  static const String identitySecretKeyName = 'finch_secret_key';
  ...
  void _log(String op, String key, {required bool present, int? len}) {
    ...
    developer.log(msg, name: 'finch.keychain');
    // ignore: avoid_print
    print('[finch.keychain] $msg');
  }
}
