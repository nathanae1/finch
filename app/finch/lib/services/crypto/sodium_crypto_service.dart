...
class SodiumCryptoService implements CryptoService {
  ...
  @override
  Future<finch.KeyPair> generateKeyPair() async {
    final kp = _sodium.crypto.sign.keyPair();
    try {
      return finch.KeyPair(
  ...
  @override
  Future<finch.KeyPair> recoverFromPhrase(List<String> words) async {
  ...
  Uint8List deriveSharedKey(
    ...
    try {
      ...
      // Step 3: crypto_kdf_derive_from_key with fixed context "finchkex".
