...
class _FinchButton extends StatelessWidget {
  const _FinchButton({
  ...
  Widget build(BuildContext context) {
    ...
    final textStyle = (block ? finch.typography.buttonBlock : finch.typography.button)
...
class FinchIconButton extends StatelessWidget {
  const FinchIconButton({
    super.key,
    required this.child,
    this.onPressed,
    this.size = 36,
  ...
  Widget build(BuildContext context) {
    ...
    return Material(
      ...
      child: InkWell(
        onTap: onPressed,
        borderRadius: BorderRadius.circular(10),
        splashColor: finch.colors.sageSoft.withValues(alpha: 0.3),
        highlightColor: finch.colors.hairline,
        hoverColor: finch.colors.linen,
        child: SizedBox(
          width: size,
          height: size,
          child: IconTheme(
            data: IconThemeData(color: finch.colors.ink, size: 20),
